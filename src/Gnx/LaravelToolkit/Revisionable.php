...
class Revisionable extends Eloquent
{
     ...
     *
     * @param boolean $creating flag to show we are creating a model record
     * @return void
     */
    public function postSave($creating = false)
    {
        // Check if we should store creations in our revision history
        // Set this value to true in your model if you want to
        if($creating && !empty($this->revisionCreationsDisabled))
        {
